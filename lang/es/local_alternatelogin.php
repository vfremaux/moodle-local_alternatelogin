...
$string['pluginname'] = 'P&aacute;gina de connecci&oacute;n alternativa';
...
$string['captchainstr'] = 'Copiez tous les nobres que vous voyez (dans l\'ordre)';
$string['login'] = 'Identifiant (ou mail)';
$string['mydashboard'] = 'Mi pantalla';
$string['signin'] = 'Conectar)';
$string['newaccount'] = 'Nueva cuenta';
$string['confirmpassword'] = 'Contrase&ntilde;a (confirmaci&oacute;n)';
...
Su cuenta a sido creada y esta esperando <b>por confirmar</b>. Va a recibir un email de confirmaci&oacute;n
en los proximos minutos a la dirrecci&oacute;n email <b>{$a}</b>. Clicea en el lazo para confirmar y acceder a
su pantalla.
';
...
$string['errorpasswordpolicy'] = 'La contra se&ntilde,a no verifica las reglas de seguridad.';
$string['errorcapchacheck'] = 'El capcha no pudo ser verificado.';
$string['errormalformed'] = 'La dirrecci&oacute;n esta malformada.';
